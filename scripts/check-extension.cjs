...
const unit=[
 ...
 'site-observations-regression.cjs','run-timing-regression.cjs','settlement-speed-regression.cjs','run-logs-regression.cjs','feedback-loop-regression.cjs',
...
const browser=['native-wait-speed-regression.cjs','ant-wait-speed-regression.cjs','extension-lifecycle-regression.cjs','phoenix-close-browser-regression.cjs','choice-close-browser-regression.cjs','zhuanzhuan-extension-regression.cjs','quick-ui-regression.cjs','sidepanel-regression.cjs','profile-readiness-browser-regression.cjs','real-extension-workflow.cjs','kuaishou-coverage-regression.cjs','pdf-import-regression.cjs'];
...
const inputs=[...runtime,...files('vendor'),'package.json',...(fs.existsSync(path.join(root,'package-lock.json'))?['package-lock.json']:[]),'scripts/check-extension.cjs','scripts/triage-run-logs.cjs',...unit.concat(browser).map(f=>'test/'+f),'test/popup-mock-chrome.js','test/extension-fixture.cjs'].sort();
